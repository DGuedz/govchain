...
export function HeroSection() {
  return (
    <section className="relative w-full py-16 md:py-32 lg:py-40 overflow-hidden bg-slate-50">
      {/* Background Gradient */}
      ...
      <div className="container px-4 lg:px-24 mx-auto relative z-10">
        <div className="flex flex-col items-center text-center space-y-6 md:space-y-8">
          ...
          <motion.div 
            ...
            className="inline-flex items-center rounded-full border border-emerald-200 bg-white/50 backdrop-blur-sm px-3 py-1 text-xs sm:text-sm font-medium text-emerald-800 mb-2 md:mb-4 shadow-sm gap-2"
          >
          ...
          >
            <h1 className="text-3xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl text-slate-900 leading-[1.1]">
              A Governança Digital da <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#50C878] to-emerald-700 block mt-2 md:mt-0">
                COOPESMERALDA
              </span>
            </h1>
            <p className="mx-auto max-w-[800px] text-slate-600 text-base md:text-xl leading-relaxed px-4">
