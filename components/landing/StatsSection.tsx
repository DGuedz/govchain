...
export function StatsSection() {
  return (
    <section className="py-24 bg-emerald-950 relative overflow-hidden border-t border-emerald-900">
      {/* Background Effects */}
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                {/* Icon Container */}
                <div className="p-3 rounded-2xl bg-emerald-900/50 border border-emerald-800 group-hover:border-[#50C878]/50 group-hover:bg-[#50C878]/10 transition-all duration-300">
                  <stat.icon className="h-6 w-6 text-emerald-400 group-hover:text-[#50C878] transition-colors duration-300" />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-emerald-400/60 font-medium text-sm uppercase tracking-wider group-hover:text-emerald-300 transition-colors">
                    {stat.label}
                  </p>
                </div>
              </div>
